...
import { withoutGatsbyImageProps } from './asGatsbyImage';
/**
 * util function to create a hoc for building a non-responsive image processed by gatsby
 */
const asPlainImage = (
