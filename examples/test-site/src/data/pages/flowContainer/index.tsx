...
const FlowContainerPage = (props: any) => (
  <Page {...props}>
    <Layout>
      <h1 className="text-3xl font-bold">Flow Container Examples</h1>
      ...
      <h2 className="text-2xl font-bold mt-4">Flow container with constrained widths</h2>
      <FlowContainerDefault
      ...
      <h2 className="text-2xl font-bold mt-4">Flow container restricted to 1 item</h2>
      <FlowContainerDefault
        id="restricted"
        nodeKey="restricted"
        maxComponents={1}
